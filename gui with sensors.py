...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def update_plot_data(self):
        ...
        # read pressure from sensor 1
        pressure = (sensor1.pressure - cal_1 - av_press)
    ...
    def update_vol_plot_data(self):
        ...
        if(flow > 1000 and self.lastFlow < 1000): # we are in inspiration
            ...
            self.tidalVolHistoryCounter += 1 # need to keep track of last 10 breaths to calc minute volume
        ...
        if(flow < 1000.0):# we are in expiration so we can measure accurately as it is laminar flow
        ...
        self.vcounter += 1  # vcounter is for tracking volume 
        ...
        spaces = "_" * (3 - int(np.log10(self.lastTidalVol))) # hack to stop label jumping around
